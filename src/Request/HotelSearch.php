...
class HotelSearch extends RequestAbstract implements RequestInterface
{
	...
	public function addHotelCode($hotelCode) {
	    array_push($this->_hotelCode,$hotelCode);
	    return $this;
    }
	...
	public function getBody() {
		...
		if(!empty($this->_hotelCode)) {
            $hotelcodes = '';
            foreach ($this->_hotelCode as $hotel) {
                $hotelcodes .= Helper::wrapTag('HotelId',$hotel);
            }
            $xml.= Helper::wrapTag('Hotels',$hotelcodes);
        }
